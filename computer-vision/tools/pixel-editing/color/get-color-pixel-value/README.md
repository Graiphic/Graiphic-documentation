...
<p>Reads the pixel values from a color image. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img alt="Get Color Pixel Value" src="assets/Get Color Pixel Value.png" width="241"/></p>
