# DeepMX Inference Assistant

## Description

DeepMX is an Express VI used to configure an ONNX model for inference with ONNX Runtime.
...
<p align="center"><img src="assets/deepmx-model-path-empty.png" alt="DeepMX model path page before selecting a model" width="780" /></p>
...
<p align="center"><img src="assets/deepmx-model-path-selected.png" alt="DeepMX model path page with an ONNX model selected" width="780" /></p>

## Model Mapping

The mapping page defines the public interface of the generated VI.

<p align="center"><img src="assets/deepmx-model-mapping.png" alt="DeepMX model mapping page" width="780" /></p>
...
If the ONNX model is available, DeepMX fills this table from the model metadata.
...
<p align="center"><img src="assets/deepmx-execution-provider-fixed.png" alt="DeepMX execution provider fixed in configuration" width="780" /></p>

If the fixed provider has dedicated parameters, DeepMX exposes the matching parameter cluster on the generated VI.
...
<p align="center"><img src="assets/deepmx-execution-provider-on-diagram.png" alt="DeepMX execution provider exposed on diagram" width="780" /></p>

## Generated VI

After validation, DeepMX drops a configured inference VI on the block diagram.

<p align="center"><img src="assets/deepmx-generated-vi.png" alt="DeepMX generated Express VI on LabVIEW block diagram" width="220" /></p>
...
<p align="center"><img src="assets/deepmx-palette.png" alt="DeepMX in the LabVIEW Deep Learning palette" width="260" /></p>

1. Drop **DeepMX** from the Deep Learning palette.
